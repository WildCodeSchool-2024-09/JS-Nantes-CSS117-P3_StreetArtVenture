...
INSERT INTO art_piece (name, adress, coordinates, is_validated, is_covered, description, points_value, picture_path)
VALUES
  ('Révolte des Couleurs', 'Rue de la Liberté, Nantes', POINT(47.218637, -1.553616), TRUE, FALSE, 'Oeuvre vibrante qui évoque la lutte pour la liberté.', 10, "example_picture.jpg"),
('Aube Nouvelle', 'Boulevard de la République, Nantes', POINT(47.210244, -1.554298), FALSE, FALSE, 'Mural représentant un lever de soleil avec des tons chauds.', 20, "example_picture.jpg"),
('Fragment du Temps', 'Place du Commerce, Nantes', POINT(47.214348, -1.556412), TRUE, TRUE, 'Street art en 3D, une immersion dans évolution du temps.', 50, "example_picture.jpg"),
('Racines Urbaines', 'Quai des Tuileries, Nantes', POINT(47.220347, -1.547512), TRUE, FALSE, 'Graffiti inspiré par les racines des arbres entrelacées avec la ville.', 10, "example_picture.jpg"),
('Silence Électrique', 'Avenue de la République, Nantes', POINT(47.211111, -1.561111), FALSE, FALSE, 'Mural qui donne une impression de calme dans un monde bruyant.', 100, "example_picture.jpg"),
('Le Dernier Souffle', 'Rue de la Gare, Nantes', POINT(47.211889, -1.565298), TRUE, FALSE, 'Street art illustrant les équilibres fragile de la nature.', 20, "example_picture.jpg"),
('Ombre des Murs', 'Rue du Bouffay, Nantes', POINT(47.213221, -1.561444), FALSE, TRUE, 'Oeuvre représentant des silhouettes perdues dans les ombres.', 50, "example_picture.jpg"),
('Évasion Électrique', 'Rue du Port, Nantes', POINT(47.218234, -1.560222), TRUE, TRUE, 'Peinture murale futuriste, évasion dans une société trop normée.', 100, "example_picture.jpg"),
('Regard Perçant', 'Place des Halles, Nantes', POINT(47.210635, -1.564292), FALSE, FALSE, 'Graffiti qui capte avec des yeux percants.', 50, "example_picture.jpg"),
('Unité des Contraires', 'Rue des Chantiers, Nantes', POINT(47.215577, -1.552344), TRUE, FALSE, 'Oeuvre sur les opposés : lumière et obscurité, mouvement et calme.', 10, "example_picture.jpg"),
('Esprit de la Rue', 'Place du Ralliement, Angers', POINT(47.473474, -0.552174), TRUE, FALSE, 'Graffiti célébrant la rue et des artistes de passage.', 10, "example_picture.jpg"),
('Le Poids des Mots', 'Rue de la Maine, Angers', POINT(47.474002, -0.551231), FALSE, FALSE, 'Mural sur les paroles et les silences, et leur poids dans la société.', 20, "example_picture.jpg"),
('Mélancolie Acier', 'Rue du Boulevard, Angers', POINT(47.476254, -0.553448), TRUE, TRUE, 'Street art représentant des pièces de métal et acier, symbole industrialisation.', 50, "example_picture.jpg"),
('Voix du Passé', 'Avenue de la Gare, Angers', POINT(47.470319, -0.557824), TRUE, FALSE, 'Mural représentant les anciens habitants de la ville et leur influence sur le présent.', 100, "example_picture.jpg"),
('Vagues de Révolte', 'Rue des Violettes, Angers', POINT(47.475883, -0.550438), FALSE, FALSE, 'Oeuvre qui exprime des idées de révolte contre les normes sociales à travers des vagues.', 20, "example_picture.jpg"),
('Sous la Peau de la Ville', 'Rue des Ponts, Angers', POINT(47.473312, -0.548576), TRUE, TRUE, 'Street art qui dévoile les structures cachées et oubliées de la ville.', 50, "example_picture.jpg"),
('Oeil du Cyclone', 'Hôtel de Ville, Angers', POINT(47.474834, -0.549197), FALSE, FALSE, 'Graffiti représentant un œil immense, vision du monde moderne vu comme un cyclone.', 10, "example_picture.jpg"),
('Dans le Vent', 'Rue de la Croix de Lorette, Angers', POINT(47.472874, -0.552905), TRUE, FALSE, 'Oeuvre inspirée par la légèreté du vent, avec des formes abstraites.', 100, "example_picture.jpg"),
('Ultime Danse', 'Place du Général Leclerc, Angers', POINT(47.470958, -0.553544), FALSE, FALSE, 'Peinture murale qui capture un mouvement de danse effréné.', 20, "example_picture.jpg"),
('Changement des Époques', 'Rue de la Fonderie, Angers', POINT(47.472273, -0.551391), TRUE, FALSE, 'Graffiti qui dépeint les changements sociaux et les transitions culturelles.', 50, "example_picture.jpg");
